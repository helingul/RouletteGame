//////////////////////////////////////////////////////////////////////////
//  Generates all BetSpot objects on the physical table.
//////////////////////////////////////////////////////////////////////////
...
public class RouletteTableLayout : MonoBehaviour
{
    ...
    public Result GenerateAllBetSpots()
    {
        ...
        if (!LoadData()) return Result.Failure;
    ...
    private bool LoadData()
    {
        ...
        if (data == null) { Debug.LogError("[RouletteTableLayout] RouletteTableData not found."); return false; }

        payoutList = Resources.Load<PayoutList>("Data/PayoutList");
        if (payoutList == null) { Debug.LogError("[RouletteTableLayout] PayoutList not found."); return false; }
...
#else
        go = Instantiate(BetSpotPrefab, parent);
#endif
