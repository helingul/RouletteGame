...
namespace RouletteGame.Ball
{
    //////////////////////////////////////////////////////////////////////////
    // Controls the roulette ball movement, including orbit spin,
    // wobble near the end of the spin, visual rolling rotation,
    // and final settle/bounce animation when attaching to the wheel.
    //////////////////////////////////////////////////////////////////////////
    public class RouletteBall : MonoBehaviour
    {
        ...
        // Calculate a backwards spinning target angle with extra full turns.
        ...
        // Re-parent ball to wheel so it follows wheel rotation after landing.
        ...
        // Gradually shrink orbit radius while slowing down rotation.
        ...
        private Vector3 OrbitPos(float angleRad, float radius)
        {
        ...
        // Rotate visual mesh based on traveled distance to fake rolling motion.
